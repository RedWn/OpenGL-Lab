...
#### 1. Go to The desired folder for the repo and open cmd/powershell

For example `D:/university/graphics-lab`

#### 2. Clone the repository

```
git clone https://github.com/RedWn/OpenGL-Lab
```

#### 3. Locate the .sln file

```
cd OpenGL-Lab\OpenGL-Lab
```

#### 4. Build the solution

```
msbuild OpenGL-Lab.sln  
```
...
Great, you have built/ran many opengl projects, without writing any C++ code (or opening visual studio at all).
